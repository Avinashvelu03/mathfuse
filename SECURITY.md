...
- **GitHub Security Advisories**: [Report here](https://github.com/Avinashvelu03/mathfuse/security/advisories/new)
...
- Always pin to a specific version in production: `"mathfuse": "1.0.3"`
